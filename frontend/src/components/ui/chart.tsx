    ...
    return (
      ...
      >
        ...
        <div className="grid gap-1.5">
          {payload.map((item: { name?: string; value?: number | string; dataKey?: string; payload?: Record<string, unknown>; color?: string; fill?: string }, index: number) => {
...
const ChartLegendContent = React.forwardRef<HTMLDivElement, ChartLegendContentProps>(
  (
    ...
    return (
      ...
      >
        {payload.map((item: { value?: string; color?: string; dataKey?: string; type?: string; id?: string }) => {
